...
@section('meta-content')
	...
	<meta property="og:image"
		content="{{ $data->og_image ? asset('public/media/' . $data->og_image) : asset('public/media/' . $data->f_thumbnail) }}" />
							...
							<div class="product_price">
								@if($data->sale_price != '')
									@if($gtext['currency_position'] == 'left')
										<div class="item-price">{{ $gtext['currency_icon'] }}{{ NumberFormat($data->sale_price) }}
										</div>
									@else
										<div class="item-price">{{ NumberFormat($data->sale_price) }}{{ $gtext['currency_icon'] }}
										</div>
									@endif
								@endif
										...
										<div class="row">
											<div class="col-lg-6">
												<div class="review-form">
													...
													<p>Please <a
															href="{{ route('frontend.login') }}"><strong>login</strong></a>
														to write review!</p>
												...
												<div class="stores-card">
													<div class="store-logo">
														@if($seller_data->photo == '')
															<span
																class="text">{{ sub_str($seller_data->shop_name, 0, 1) }}</span>
														@else
															<img src="{{ asset('public/media/' . $seller_data->photo) }}"
														...
														<div class="rating-wrap">
															<div class="stars-outer">
																<div class="stars-inner"
																	style="width:{{ $SellerReview['ReviewPercentage'] }}%;">
																</div>
															</div>
															<span
																class="rating-count">({{ $SellerReview['TotalReview'] }})</span>
														</div>
														<ul class="info">
															<li><i class="bi bi-telephone"></i>{{ $seller_data->phone }}
															</li>
															<li><i class="bi bi-envelope"></i>{{ $seller_data->email }}</li>
															<li><i class="bi bi-geo-alt"></i>{{ $seller_data->address }}
															</li>
														</ul>
													</div>
												</div>
