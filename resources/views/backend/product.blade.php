											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<select name="cat_id" id="cat_id" class="chosen-select form-control">
														<option value="" selected="selected">{{ __('Select Category') }}
														</option>
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<input value="{{ $datalist['sale_price'] }}" name="sale_price"
														id="sale_price" type="text" class="form-control parsley-validated"
														data-required="true">
												</div>
											</div>
										</div>
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<select name="is_featured" id="is_featured"
														...
														<option {{ 1 == $datalist['is_featured'] ? "selected=selected" : '' }}
															value="1">{{ __('YES') }}</option>
														<option {{ 0 == $datalist['is_featured'] ? "selected=selected" : '' }}
											...
											<div class="col-lg-6">
												<div class="form-group">
													...
													<select name="collection_id" id="collection_id"
														class="chosen-select form-control">
														<option {{ 1 == $datalist['collection_id'] ? "selected=selected" : '' }}
															value="1">{{ __('YES') }}</option>
														<option {{ 0 == $datalist['collection_id'] ? "selected=selected" : '' }}
															value="0">{{ __('NO') }}</option>
													</select>
												</div>
											</div>
												...
												<div class="form-group">
													...
													<div class="tp-upload-field">
														<input value="{{ $datalist['f_thumbnail'] }}" type="text"
															name="f_thumbnail" id="f_thumbnail_thumbnail" class="form-control"
															readonly>
